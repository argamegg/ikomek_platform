    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <ScrollView contentContainerStyle={[styles.scroll, { paddingBottom: insets.bottom + 100 }]}>
        ...
        <View style={styles.profileCard}>
          <View style={styles.avatar}><Text style={styles.avatarText}>{getInitials(user?.full_name || 'O')}</Text></View>
        ...
        <TouchableOpacity style={styles.logoutBtn} onPress={handleLogout} data-testid="operator-logout-btn">
...
const styles = StyleSheet.create({
  ...
  roleBadge: { backgroundColor: '#007AFF15', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 8 },
  roleText: { fontSize: 11, fontWeight: '600', color: '#007AFF' },
