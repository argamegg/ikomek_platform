  ...
  en: {
    translation: {
      ...
      chat: {
        ...
        unavailableDescription: "Only the request author, operators, and admins can use request chat.",
      },
      notFound: {
  ...
  ru: {
    translation: {
      ...
      chat: {
        ...
        unavailableDescription: "Чатом могут пользоваться только автор заявки, операторы и администраторы.",
      },
      notFound: {
  ...
  kz: {
    translation: {
      ...
      chat: {
        ...
        unavailableDescription: "Чатты тек өтінім авторы, операторлар және әкімшілер пайдалана алады.",
      },
      notFound: {
        title: "Бет табылмады",
