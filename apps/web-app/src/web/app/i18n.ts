  ...
  en: {
    translation: {
      ...
      auth: {
        ...
        description:
          "Web and mobile share the same authentication, profiles, requests, and chat history.",
        loginTab: "Sign in",
  ...
  ru: {
    translation: {
      ...
      auth: {
        ...
        description:
          "Веб и мобильное приложение используют одну аутентификацию, профили, заявки и историю чатов.",
        loginTab: "Вход",
  ...
  kz: {
    translation: {
      ...
      auth: {
        ...
        description:
          "Веб және мобильді қосымша бір аутентификацияны, профильдерді, өтінімдерді және чат тарихын бөліседі.",
        loginTab: "Кіру",
        registerTab: "Тіркелу",
